  ...
  return (
    <section aria-labelledby="new-heading">
      <div className="rounded-lg bg-white shadow">
        <div className="p-6">
          <h2 id="new-heading" className="text-base font-medium text-gray-900">New</h2>
          <div className="mt-6 flow-root">
            <ul className="-my-4 divide-y divide-gray-200">
              {newsItems !== undefined && newsItems.length > 1 ? newsItems.map((n) => <NewsItem key={`news-${n.id}`} newsItem={n} />) : (
                <li>
                  No News
                </li>
              )}
