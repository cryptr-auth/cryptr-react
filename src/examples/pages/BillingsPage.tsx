...
const BillingsPage = (): ReactElement => {
  ...
  const {decoratedRequest, isAuthenticated, getCurrentAccessToken} = useCryptr()
      ...
      <div className="flex flex-col">
        {isAuthenticated() ? (
          <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            {accessToken && (
              <div style={{maxWidth: '100%', overflowX: 'hidden'}} className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                      ...
                      return (
                        <tr key={billing.date}>
                          ...
                          <td className="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                            <a href={billing.receiptUrl} rel="noreferrer" className="text-orange-600 hover:text-orange-900" target="_blank">
                              View receipt
                            </a>
                          </td>
                        </tr>
